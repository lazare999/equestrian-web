  ...
  return (
    <div className={classes.container}>
      <div className={classes.popContainer}>
        <h2>
          აღმოაჩინეთ საქართველოს საუკეთესო თავლები -<br /> ყველაფერი, რაც თქვენ უნდა იცოდეთ, ერთ
          სივრცეში!
        </h2>
        <Image
      ...
      >
        ...
        <p>
          ეს ყველაფერი დაგეხმარებათ შეარჩიოთ საუკეთესო თავლა თქვენი საჭიროებების შესაბამისად,
          დაზოგოთ დრო და მიიღოთ ზუსტად ის გამოცდილება, რასაც ეძებთ.
        </p>
        <p>
          შეარჩიეთ თავლა მარტივად, დაგეგმეთ თქვენი ვიზიტი და დატკბით ცხენოსნობის დაუვიწყარი
          მომენტებით!
        </p>
      </div>
    </div>
